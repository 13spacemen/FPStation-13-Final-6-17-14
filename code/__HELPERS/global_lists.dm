...
var/global/list/questions_list = list()				//list of all surgeries by name, associated with their path.
...
/proc/make_datum_references_lists()
	...
	//questions
	paths = typesof(/datum/question) - /datum/question
	for(var/path in paths)
		var/datum/question/S = new path()
		questions_list = S
	//	questions_list[S.name] = S
...
/client/verb/debug_chemical_list()
	...
	for (var/reaction in chemical_reactions_list)
		...
		if(islist_legacy(chemical_reactions_list[reaction]))

...
//				else									rest.icon_state = "rest0"
		...
		//		if(blinded)		blind.layer = 18
			//	else			blind.layer = 0
				if(blinded)	blind.alpha = 255 //HAHA I FIX BLIND
				else		blind.alpha = 0//TODO: Byond somehow fucked with layers on update 510 making you permablind, this prevents that but is REALLY not a good fix

...
/obj/item/pipe/proc/update()
	...
	icon_state = islist_legacy[pipe_type + 1]
...
/obj/item/pipe/verb/rotate()
	...
	if (pipe_type in list (PIPE_SIMPLE_STRAIGHT, PIPE_HE_STRAIGHT, PIPE_MVALVE))
		if(dir==2)
			dir = 1
		else if(dir==8)
			dir = 4
...
/obj/item/pipe/Move()
	...
	else if (pipe_type in list (PIPE_SIMPLE_STRAIGHT, PIPE_HE_STRAIGHT, PIPE_MVALVE))
		if(dir==2)
			dir = 1
		else if(dir==8)
			dir = 4
